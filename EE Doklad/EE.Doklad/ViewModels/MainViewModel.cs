    ...
    public partial class MainViewModel : ObservableObject
    {
        ...
        private Report CreateSampleReport()
        {
            ...
            for (int i = 0; i < earlyTitles.Length; i++)
            {
                ...
                // Ако е секция 4. Въведение, добавяме фиксирана таблица
                if (earlyTitles[i].Contains("Въведение"))
                {
                    var table = new FixedTable
                    {
                        Title = "Описание на извършените дейности",
                        ColumnHeaders = new System.Collections.Generic.List<string> { "Проверени елементи в проекта", "Констатации" }
                    };
                    // Добавяме редове по шаблон от снимката
                    table.Rows.Add(new Row { Cells = { new Cell { Value = "Обяснителна записка" }, new Cell { Value = "Съдържа описание на основанието за изготвяне на част \"Енергийна ефективност\"" } } });
                    table.Rows.Add(new Row { Cells = { new Cell { Value = "Технически изчисления" }, new Cell { Value = "" } } });
                    table.Rows.Add(new Row { Cells = { new Cell { Value = "Определяне коефициентите на топлопреминаване U на ограждащите елементи и конструкции:" }, new Cell { Value = "Изчислени са коефициентите на топлопреминаване на ограждащите елементи и конструкции." } } });
                    table.Rows.Add(new Row { Cells = { new Cell { Value = "Определяне на коефициента на топлинни загуби от топлопреминаване, Ht" }, new Cell { Value = "Изчислен съгласно Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" } } });
                    table.Rows.Add(new Row { Cells = { new Cell { Value = "Определяне на коефициента на топлинни загуби от вентилация" }, new Cell { Value = "Изчислен съгласно Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" } } });
                    table.Rows.Add(new Row { Cells = { new Cell { Value = "Определяне на топлинните печалби от слънчево греене" }, new Cell { Value = "Изчислен съгласно Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" } } });
                    table.Rows.Add(new Row { Cells = { new Cell { Value = "Определяне на годишната потребна топлина за отопление Qh" }, new Cell { Value = "Изчислен съгласно Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" } } });
                    table.Rows.Add(new Row { Cells = { new Cell { Value = "Определяне на специфичната стойност на годишната потребна топлина за отопление на единица квадратен метър отопляема площ" }, new Cell { Value = "Изчислен съгласно Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" } } });
                    table.Rows.Add(new Row { Cells = { new Cell { Value = "Сравнение на специфичната стойност на годишната потребна топлина за отопление с нормативната стойност за потребна топлина за единица квадратен метър отопляема площ" }, new Cell { Value = "Свойността на специфичната потребна топлина за сградата не надвишава максималната нормативна стойност" } } });
