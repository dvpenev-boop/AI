...
namespace EE.Doklad.Views.FloorPanels
{
    public partial class FloorExternalAirPanel : UserControl
    {
        ...
        // Removed shared MaterialSearchText handlers. Using per-layer MaterialOptions and WPF TextSearch instead.
        ...
        private void InjectMaterialOptionsIntoLayers()
        {
            ...
            if (DataContext is FloorExternalAirDetail detail && options != null)
            {
