...
namespace EE.Doklad.Tests.Validation.FullOracle
{
    public sealed class EECalcVentilationOracle
    {
            ...
            IReadOnlyList<HourlyClimateData> hourly)
        {
            ...
            AccumulateDay(input.WorkdaySchedule, month.WorkDays, false, fixture, input, shifted, ref powHeating, ref powCooling, ref withering, ref coolingInputs);
            AccumulateDay(input.SaturdaySchedule, month.Saturdays, true, fixture, input, shifted, ref powHeating, ref powCooling, ref withering, ref coolingInputs);
            AccumulateDay(input.SundaySchedule, month.Sundays, true, fixture, input, shifted, ref powHeating, ref powCooling, ref withering, ref coolingInputs);
            ...
            ref double coolingInputs)
        {
            ...
            for (var hour = schedule.StartHour; hour < schedule.EndHour && hour < 24; hour++)
            {
                ...
                var selectedTemp = IsCoolingProjectHour(hour, fixture.WorkdaySchedule, inclusiveCoolingScheduleEnd)
