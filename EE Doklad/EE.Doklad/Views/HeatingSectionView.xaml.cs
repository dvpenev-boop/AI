...
{
    /// <summary>
    /// Interaction logic for HeatingSectionView.xaml
    /// </summary>
    public partial class HeatingSectionView : UserControl
    {
        public HeatingSectionView()
        {
            InitializeComponent();
            Loaded += HeatingSectionView_Loaded;
        }

        private void HeatingSectionView_Loaded(object sender, RoutedEventArgs e)
        {
