...
namespace EE.Doklad.Tests.Validation
{
    public sealed class EecalcCoolingEsmCalculator
    {
        ...
        private readonly EecalcMonthlyCoolingOracle coolingOracle;

        public EecalcCoolingEsmCalculator(CoolingFreeMode coolingFreeMode = CoolingFreeMode.EECalcLegacy)
        {
            coolingOracle = new EecalcMonthlyCoolingOracle(coolingFreeMode);
        }
