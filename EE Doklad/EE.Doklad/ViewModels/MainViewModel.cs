...
namespace EE.Doklad.ViewModels
{
    public partial class MainViewModel : ObservableObject
    {
        ...
        {
            return @"ОБОБЩЕНИЕ НА ИЗВЪРШЕНИТЕ ДЕЙНОСТИ

При разработката на настоящия технически доклад е извършено преглед на проектна документация и определяне на енергийни характеристики на строителните елементи (външни стени, покрив, под, прозорци, врати и др.) както и на техничските системи за отопление, охлаждане, вентилация и осветление.

Определянето на коефициентите на топлопроводимост на отграждащите елементи на строенето е извършено съгласно Наредба 7/2004 (изм. - ДВ, бр. 93 / 2017 г.) и съответните Европейски стандарти БДС EN 12831 и БДС EN ISO 832.

Методология на анализа

Съгласно българския метод за определяне на енергийната характеристика:
• Топлинните потребности на сградата се определят на база на климатични данни, параметри на строителната конструкция, характеристики на техничките системи и експлоатационни условия.
• Се използват интегрирани системни подходи и специфични енергийни характеристики на съответните технически системи.
• Се приемат изчисления по отношение на конкретното място и специфично описание на параметрите по извършения анализ.

Приложени окончателни резултати от анализа показват енергийната производителност на сградата по отношение на нейните характеристики, изчисляване на технически жизнеспособност и определяне на условия и мерки за енергийна ефективност на сградата.";
        }
        ...
        private List<Row> CreateIntroductionTableRows()
        {
            ...
            // Данни от снимка 2 - Проверени елементи
            var tableData = new[]
            {
                new[] { "Обсегтялата записка", "Съдържа описание на основното за изчисление на част. Енергийна ефективност" },
                new[] { "Определение коефициентите на топлопроводимост на отграждащите елементи", "Изчисления със коефициентите на топлопроводимост максимално допустими, определени в таблица №1, чл.10, з.4 от Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" },
                new[] { "Определение на коефициентите на топлинни загуби от вентилация", "Изчисления согласно Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" },
                new[] { "Определение на топлинните печалби от слънчево греене", "Изчисления согласно Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" },
                new[] { "Определение на топлинните потребности топлина за отопление на сградата Q o", "Изчисления согласно Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" },
                new[] { "Определение на специфициран стойност на годишната потребност топлина за отопление и охлаждане на сграда", "Изчисления согласно Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" },
                new[] { "Сравнение на специфициран стойност на годишната потребност топлина за отопление и охлаждане на сграда, относно на нормативното стойност из потребност горша, или следствено потребност горша или следствено потребност приложение №3 на Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)", "Стойност согласно Наредба 7/2004 (Изм. – ДВ, бр. 93 / 2017 г.)" }
            };
